...
const getAppName = () => {
    ...
    const defaultApp = app_1.default === null || app_1.default === void 0 ? void 0 : app_1.default.app();
    // Return the name of the Firebase app if it's not '[DEFAULT]', otherwise return the bundle ID
    return (defaultApp === null || defaultApp === void 0 ? void 0 : defaultApp.name) !== '[DEFAULT]' ? defaultApp.name : react_native_device_info_1.default.getBundleId();
};
