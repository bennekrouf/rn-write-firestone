...
const writeToAsyncStorage = (data, merge) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const mergedData = merge ? Object.assign(Object.assign({}, existingData), data) : Object.assign({}, data);
        ...
        yield async_storage_1.default.setItem(userKey, JSON.stringify({ [userKey]: JSON.stringify(mergedData) }));
        console.log(`Data merged and stored in AsyncStorage ${JSON.stringify(yield async_storage_1.default.getItem(userKey))}`);
    }
    catch (error) {
